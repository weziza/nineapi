module.exports = {
	...
	token: "Njk0NzI3NDMzNzkzODMwOTMz.XoP6HA.M64NSjpb1h6K5ZXyz1QyT2B79nI",
	/* For the support server */
	support: {
		id: "312933750034006016", // The ID of the support server
		logs: "511527004080963634", // And the ID of the logs channel of your server (new servers for example)
	},
	...
	mongoDB: "mongodb+srv://weziza:weziza@cluster0-jwbsc.mongodb.net/test?retryWrites=true&w=majority", // The URl of the mongodb database
	prefix: "!", // The default prefix for the bot
	/* For the embeds (embeded messages) */
	embed: {
		color: "#0091fc", // The default color for the embeds
		footer: "/n" // And the default footer for the embeds
	},
	defaultLanguage: "english", // The default language for the new servers
	botname: "二郎", // The name of the bot
	/* Bot's owner informations */
	owner: {
		id: "312933589811462145", // The ID of the bot's owner
		name: "weziza#2310" // And the name of the bot's owner
	},
	...
	apiKeys: {
		...
		simpleYoutube: "AIzaSyCS6L1JQx8k3l793bEBMHYtjxBBeaPudRQ",
	...
	others: {
		github: "https://github.com/weziza", // Founder's github account
		donate: "https://discordapp.com" // Donate link
	},
